...
// URL triggers are client-scoped RSM configuration. Customer-scoped tokens can enqueue
// them, but partially configured customer scopes still fail closed.
if (!RSisTokenCustomerScopeValid($RStoken)) {
      dieWithError(403);
}
