...
function saveImgCache($imageOriginal, $imagePath, $imageName, $extension)
{
    ...
    switch ($extension) {
        case "jpg" :
            return imagejpeg($imageOriginal, $imagePath . "_" . rawurlencode(base64_encode($imageName)) . "." . $extension);
        case "gif" :
            return imagegif($imageOriginal, $imagePath . "_" . rawurlencode(base64_encode($imageName)) . "." . $extension);
        case "png" :
            imagealphablending($imageOriginal, false);
            imagesavealpha($imageOriginal, true);
            return imagepng($imageOriginal, $imagePath . "_" . rawurlencode(base64_encode($imageName)) . "." . $extension);
        case "svg" :
