...
$oldVersion = "5.1.1.3.122";
$newVersion = "5.1.2.3.123";
...
// Include other php update files
include "./phpUpdate_From_v" . $oldVersion . "_to_v" . $newVersion . "/updateInvoiceProviderPaymentDate.php";
include "./phpUpdate_From_v" . $oldVersion . "_to_v" . $newVersion . "/updateSintaxisAddRule.php";

//Launch the first update php for the defined clients
$clientsToUpdate = array();
//empty to check all clients
//$clientsToUpdate[] = '1'; //Redsauce Client
echo start_update_payment_date($clientsToUpdate);

//Launch the second update php for the defined clients
$clientsToUpdate = array();
//empty to check all clients
//$clientsToUpdate[] = '1'; //Redsauce Client
echo start_update_sintaxis_addrule($clientsToUpdate);
