...
if (empty($allowedItemTypes) || $allowedItemTypes[0] == "") {
...
foreach ($results as $result) {
  if ($result['parentPropertyID'] != '0' && !isPropertyVisible($RSuserID, $result['parentPropertyID'], $clientID) && !in_array($result['nodeItemType'], $notAllowedItemtypes)) {
