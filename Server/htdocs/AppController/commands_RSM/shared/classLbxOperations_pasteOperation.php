...
$results['subAccount'] = translateSingleIdentifier(getClientPropertyID_RelatedWith_byName($definitions['operationSubAccountID'], $clientID), getPropertyValue($definitions['operationSubAccountID'], $newOperationID, $clientID), $clientID);
$results['operationID'] = getPropertyValue($definitions['operationOperationID'], $newOperationID, $clientID);
$results['relatedOperations'] = translateMultiIdentifier(getClientPropertyID_RelatedWith_byName('operations.relatedOperations', $clientID), getPropertyValue('operations.relatedOperations', $newOperationID, $clientID), $clientID);
