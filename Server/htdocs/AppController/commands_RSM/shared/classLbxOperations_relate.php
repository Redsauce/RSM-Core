...
$operation_1 	= $GLOBALS[$cstRS_POST]['operation_1'	];  // a bank statement
$operation_2 	= $GLOBALS[$cstRS_POST]['operation_2'	];  // an invoice
$setPayDate 	= $GLOBALS[$cstRS_POST]['setPayDate'	];
