...
$ordenPropertyID		 = getClientPropertyID_RelatedWith_byName($definitions['conceptOrden'], $clientID);
...
$returnProperties[] = array('ID' => $ordenPropertyID, 'name' => 'orden');
if($pendingStockPropertyID!=0) $returnProperties[] = array('ID' => $pendingStockPropertyID, 'name' => 'pendingStockID', 'trName' => 'pendingStock');
