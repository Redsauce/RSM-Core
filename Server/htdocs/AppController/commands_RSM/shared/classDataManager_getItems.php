...
if ($itemTypeID == '') RSReturnError("COULD NOT DETERMINE ITEM TYPE ID TO RETURN", "NOK");
...
if ($filters != '') {
    ...
    foreach ($filters as $filter) {
        ...
        if(count($filterArr) >= 2){
            ...
            if(count($filterArr) == 3) $filterProperties[count($filterProperties)-1]['mode'] = $filterArr[2];
        }
    }
}
